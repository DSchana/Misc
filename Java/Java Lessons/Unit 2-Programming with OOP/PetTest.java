 ...
 * There is code in comments that needs to be uncommented. For example
 * once you have a Tamagotchi.java program that compiles uncomment
 * 	//Tamagotchi pet;
 * Once your constructor works uncomment:
